...
namespace NSubstitute.Elevated.Tests {
    class PatchingSubstituteManager : IProxyFactory
    {
        ...
        public PatchingSubstituteManager(ISubstitutionContext substitutionContext)
        {
        ...
        object IProxyFactory.GenerateProxy(ICallRouter callRouter, Type typeToProxy, Type[] additionalInterfaces, object[] constructorArguments)
        {
            ...
            object proxy;
            var substituteConfig = PatchingSubstituteContext.TryGetSubstituteConfig(callRouter);
